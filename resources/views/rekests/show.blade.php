<x-app-layout>
    <div class="container mx-auto p-6">
        ...
        <div class="mb-6 p-6 bg-white rounded-lg shadow-md">
            ...
            <a href="{{ route('rekests.edit', $rekest->id) }}" class="text-pink-500 hover:text-pink-700 mt-4 inline-block">
                Editar Pedido
            </a>
        </div>
                        ...
                        @foreach($rekest->products as $productInRequest)
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b">
                                    <!-- Aquí puedes agregar enlaces para eliminar o editar el producto en el pedido -->
        ...
        <div class="mt-4">
            <a href="{{ route('productsinrequests.create', $rekest->id) }}" class="bg-pink-500 text-white py-2 px-6 rounded-lg hover:bg-pink-600">
                Agregar Producto
            </a>
        </div>
    </div>
